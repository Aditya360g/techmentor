...
const initialNotifications = [
  {
    ...
    message:
      "RKGIT has shortlisted you for a Java + DSA training program.",
    time: "10 min ago",
    read: false,
  },
  {
    ...
    message:
      "Your demo session with Tech Institute is scheduled for tomorrow.",
    time: "45 min ago",
    read: false,
  },
  {
    ...
    message:
      "₹24,000 payment has been processed for your completed program.",
    time: "Yesterday",
    read: true,
  },
  {
    ...
    message:
      "Your Spring Boot program with XYZ College is now active.",
    time: "2 days ago",
    read: true,
  },
];
